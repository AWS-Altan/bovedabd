	...
	<div class="panel panel-default card-view">
		...
		<div class="panel-wrapper collapse in">
			<div class="panel-body">
				<h3><span class="head-font">Creación de pre registro</span></h3>
				</br>
				<section>
					<form id="frmCreatePreRegister">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-actions button-search" style="text-align: right;">
									<a id="btnCreate" class="btn btn-success btn"><span>Crear PreRegistro</span></a>
								</div>
							</div>
						</div>
						<div class="row">
