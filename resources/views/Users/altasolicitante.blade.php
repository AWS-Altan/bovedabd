			...
			<div class="panel-wrapper collapse in">
				<div class="panel-body">
					<div id="example-basic">
						<h3><span class="head-font capitalize-font">Alta de Soliciante</span></h3>
						<section>
                            <!-- Contenedor -->
                            <form id="form_tabs" action="#">
                                <div class="panel panel-default">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Campo de Apellido Paterni de Solicitante -->
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group mt-12">
                                                    <div class="col-sm-3 mb-20">
												        <label class="help-block text-left">Apellido Paterno solicitante</label>
                                                    </div>
                                                    <div class="col-sm-4 mb-20">
														<input type="text" data-minlength="10" class="form-control" id="cmd_PaternoAlta" placeholder="Ingrese el pellido paterno del solicitante" data-error="Valor inválido" maxlength="150">
													    <div class="help-block with-errors" id="err_msg_PaternoAlta"></div>
												    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function finished(){
        ...
        $.ajax(
        {
			...
			type: 'GET',
		 	data: {
				'nombre'	    : $('#cmd_NombreAlta').val(),
                'paterno'	    : $('#cmd_PaternoAlta').val(),
