	...
	<div class="form-wrap" style="display: inline-block; width: 320px">
			<form id="form_identify">
				<div class="form-group">
					<input type="text" data-minlength="10" class="form-control" id="cmd_searchdata" placeholder="Ingrese Correo de usuario a consultar" data-error="Valor inv�lido" maxlength="10">
